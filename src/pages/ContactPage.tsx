    ...
    <div className="min-h-screen py-16 px-4 bg-slate-900">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">
          Contact
          <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent"> Us</span>
        </h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Have questions? Need help? Our support team is here 24/7 to assist you with anything you need.
        </p>
      </div>
            ...
            return (
              <Card key={index} className="bg-card/50 backdrop-blur-sm border-border/50 hover:bg-card/80 transition-all duration-300 hover:scale-105">
                ...
                <CardContent className="text-center">
                  <p className="text-blue-400 font-medium mb-4">{method.detail}</p>
      ...
      <div className="max-w-7xl mx-auto mb-16">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">
          Our <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Offices</span>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
