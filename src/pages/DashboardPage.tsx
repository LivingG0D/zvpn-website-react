...
const quickActions = [
  { icon: Settings, title: 'Settings', description: 'Configure app preferences', href: '/settings' },
  { icon: CreditCard, title: 'Billing', description: 'Manage subscription', href: '/billing' },
  { icon: HelpCircle, title: 'Support', description: 'Get help', href: '/contact' },
  { icon: User, title: 'Profile', description: 'Edit account details', href: '/profile' }
]
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <p className="font-medium">{connectionStatus.server}</p>
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <p className="font-medium">{connectionStatus.protocol}</p>
                        </div>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div>
                        <div className="flex items-center justify-between">
                          ...
                          >
                            {showRealIp ? <EyeOff className="h-3 w-3" /> : <Eye className="h-3 w-3" />}
                          </Button>
                        </div>
                        <p className="font-medium font-mono">
                          {showRealIp ? connectionStatus.ip : connectionStatus.protectedIp}
                        </p>
                      </div>
                      <div>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div className="text-center md:col-span-1 col-span-2">
                    ...
                    <p className="text-2xl font-bold">{connectionStatus.dataUsed}</p>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-xs">{accountInfo.nextBilling}</span>
                  </div>
                </div>
              ...
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Enable auto-connect on untrusted networks for maximum protection.
                  </p>
