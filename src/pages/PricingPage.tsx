	...
	return (
		<div className="min-h-screen py-16 px-4 bg-slate-900">
			...
			<div className="max-w-4xl mx-auto text-center mb-16">
				<Badge
					variant="secondary"
					className="mb-4 bg-green-500/20 text-green-200 border-green-500/50"
				>
				...
				<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
					Choose the plan that's right for you. All plans include our 30-day
								...
								<CardContent className="text-center pb-4">
									<div className="mb-4">
										...
										{billingCycle === "yearly" && plan.yearlyPrice && (
											...
											>
												Save{" "}
												{calculateSavings(plan.originalPrice, plan.yearlyPrice)}
												%
											</Badge>
										)}
									</div>
				...
				<div className="space-y-6">
					...
					<Card className="bg-card/50 backdrop-blur-sm border-border/50">
						<CardContent className="pt-6">
							...
							<p className="text-muted-foreground">
								...
								and cryptocurrency for maximum privacy.
							</p>
						</CardContent>
					</Card>
					...
					<Card className="bg-card/50 backdrop-blur-sm border-border/50">
						<CardContent className="pt-6">
							...
							<p className="text-muted-foreground">
								Absolutely! We offer a full 30-day money-back guarantee with no
								questions asked. If you're not satisfied, we'll refund your
								payment.
							</p>
						</CardContent>
					</Card>
