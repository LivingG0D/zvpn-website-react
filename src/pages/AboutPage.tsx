...
const values = [
  {
    icon: Shield,
    title: 'Privacy First',
    description: 'We believe privacy is a fundamental human right. Everything we do is designed to protect your digital privacy.'
  },
  {
    icon: Heart,
    title: 'User-Centric',
    description: 'Our users are at the center of everything we do. We build features that matter to you.'
  },
  {
    icon: Lightbulb,
    title: 'Innovation',
    description: 'We constantly innovate to stay ahead of threats and provide cutting-edge security solutions.'
  },
  {
    icon: Globe,
    title: 'Global Access',
    description: 'We believe everyone should have access to a free and open internet, regardless of location.'
  }
]
...
const milestones = [
  {
    ...
    description: 'zVPN was founded with a mission to make online privacy accessible to everyone.'
  },
  {
    year: '2020',
    title: '1M Users',
    description: 'Reached our first million users with servers across 25 countries.'
  },
  {
    year: '2021',
    title: 'No-Logs Audit',
    description: 'Completed independent security audit confirming our zero-logs policy.'
  },
  {
    year: '2022',
  ...
  },
  {
    year: '2023',
    title: '10M+ Users',
    description: 'Surpassed 10 million users trusting zVPN for their online privacy.'
  },
  {
    year: '2024',
    ...
    <div className="min-h-screen py-16 px-4 bg-slate-900">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          We're on a mission to make online privacy and security accessible to everyone. 
          Our team of security experts and privacy advocates work tirelessly to protect your digital rights.
        </p>
      </div>
        ...
        <Card className="bg-gradient-to-r from-slate-900/50 to-blue-900/50 border-border/50">
          <CardContent className="pt-8 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              To provide everyone with the tools they need to protect their online privacy, 
              access information freely, and secure their digital lives. We believe that privacy 
              is not a luxury, but a fundamental right that should be accessible to all.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="max-w-4xl mx-auto mb-20">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
          Our <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Journey</span>
        </h2>
      ...
      <div className="max-w-4xl mx-auto mb-20">
        <Card className="bg-card/50 backdrop-blur-sm border-border/50">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-base">
              We're committed to transparency and regularly undergo independent security audits
            </CardDescription>
          </CardHeader>
          <CardContent>
