...
const testimonials = [
  {
    content: "zVPN has been a game-changer for my online privacy. The speed is incredible and I feel completely secure.",
    author: "Sarah Chen",
    role: "Digital Nomad",
    rating: 5,
  },
  {
    content: "As a journalist, protecting my sources is crucial. zVPN's no-logs policy gives me peace of mind.",
    author: "Marcus Rodriguez",
    role: "Investigative Journalist", 
    rating: 5,
  },
  {
    content: "I can finally access my favorite shows while traveling. The global server network is amazing!",
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-24 px-4 text-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Experience the internet without limits. zVPN provides military-grade security, 
            lightning-fast speeds, and access to content worldwide.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Button size="lg" variant="outline" className="border-blue-400 text-blue-100 hover:bg-blue-500/20">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Why Choose <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">zVPN</span>?
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Built with cutting-edge technology to provide you with the best online experience
            </p>
          </div>
      ...
      <section className="py-24 px-4 bg-gradient-to-r from-slate-900/50 to-blue-900/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Trusted by <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Millions</span>
            </h2>
      ...
      <section className="py-24 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Join millions of users who trust zVPN for their online privacy and security
          </p>
